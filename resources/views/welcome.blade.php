    ...
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Descubre</h3>
                <p class="text-gray-600">Encuentra nuevas recomendaciones basadas en tus gustos y preferencias.</p>
            </div>
        </div>
    </div>
@endsection
